...
def download_expenditure_data(m, api_key='SVKYD1000214620210829043226DOVGD', path='/home/henry/municipal-finance-data/', year=2018, d=1):
    ...
    for month in range(1, 13):
        ...
        for day in range(1, monthrange(year, month)[1] + 1):
            ...
            for pIndex in range(2, n_pages+1):
...
if __name__ == '__main__':
    ...
    PATH = '/home/henry/municipal-finance-data'
    ext = '.xml'
    erase_all_with_extension(PATH, ext)
    # Key = 'SVKYD1000214620210829043226DOVGD'
    pool = Pool(processes=4)
    pool.map(download_expenditure_data, [1, 2, 3])
